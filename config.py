...
SRC_EMAIL = "dy1983@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "http://kindle4dy.appspot.com/" #Your domain of app
...
MY_FEEDS_TITLE = u'Kindle Magazine'
MY_FEEDS_DESC = u'RSS delivering for kindle'
